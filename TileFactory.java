...
public class TileFactory {
    ...
    public Tile createTile(int mapIcon) {
		...
		break;
		case 40:
	    tile = new DoorTile("doorClosed_mid.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
			tile.isSolid = true;
		break;
		case 41:
		...
		break;
		case 69:
	    tile = new sprungTile("spring.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
			tile.isSolid = false;
		break;
		case 70:
	    tile = new sprungTile("sprung.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
			tile.isSolid = false;
		break;
		case 71:
		...
		break;
		case 183:
	    tile = new doorTop2("doorClosed_top.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
			tile.isSolid = false;
		break;
		case 184:
	    tile = new doorMid("doorClosed_mid.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
			tile.isSolid =false;
		break;
